			...
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						...
						<p class="meta">Posted by <a href="#">Someone</a> <?php echo $newsItem['date'];?>
							&nbsp;&bull;&nbsp; <a href="#" class="comments">Comments (64)</a> &nbsp;&bull;&nbsp; <a href="/news/<?php echo $newsItem['id'];?>" class="permalink">Full article</a></p>
						<div class="entry">
